...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Ingresar sus datos de usuario para iniciar sesión</p>

    <form action="<?php echo base_url(); ?>index.php/backend/escritorio" method="post">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox"> Recuérdame para la proxima vez
            </label>
          </div>
        </div>
        <!-- /.col -->
    ...
    <a href="register.html" class="text-center">Solicitar registro de nuevo usuario</a>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
